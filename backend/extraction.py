...
class ExtractionService:
    ...
    def extract_crm_data(self, transcript: str) -> Dict[str, Optional[object]]:
        ...
        prompt = (
            ...
            '"important_details": []}\n\n'
            "Rules:\n"
            "- Use null for any field that is not explicitly stated in the transcript. "
            "Do not guess or invent names, phone numbers, companies, or any other detail.\n"
            "- important_details is a list of short strings for any other notable facts "
            "mentioned; leave it as an empty list if there are none.\n\n"
            f"Transcript:\n{transcript.strip()}"
        )
        messages = [
